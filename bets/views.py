...
def betsHome(request, weekId="1", leagueName=""):
    if request.method == "POST":
        ...
        return render(request, 'bets/betsHome.html', {'pickData': pickData, 'userLeagues': userLeagues, 'currentWeek': currentWeek, 'activeLeague': activeLeague, 'weeks': weeks, 'userScore': userScore})